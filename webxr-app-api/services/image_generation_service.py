...
class ImageGenerationService:
    def __init__(self):
        ...
        self.model_path = "Efficient-Large-Model/Sana_Sprint_1.6B_1024px_diffusers" #"Efficient-Large-Model/Sana_Sprint_0.6B_1024px_diffusers"
        self.device = None
    ...
    def generate_image_from_prompt(self, object_name, prompt, output_dir, seed=None):
        ...
        try:
            ...
            gen = torch.Generator("cude").manual_seed(seed) if seed is not None else None
            ...
            logger.info(formatted_object_name)
